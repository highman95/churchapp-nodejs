...
exports.dailyMinistersSummary = (station_id, month_year, cb) => {
  ensureCallBackIsDefined(cb);
...
exports.wsfMeetingSummary = (station_id, month_year, cb) => {
  ensureCallBackIsDefined(cb);
...
exports.weeklyServiceSummary = (station_id, month_year, cb) => {
  ensureCallBackIsDefined(cb);
